...
This project is the main backend project of the **FOR-YOURSELF** project ecosystem, primarily including common modules,
gateway modules, and account management modules.  
...
In principle, as long as the following principles are not violated, it can be used:
